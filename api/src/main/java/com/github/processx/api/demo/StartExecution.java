 ...
 */
public class StartExecution implements AutoExecution {

  /** 日志记录 */
  private static final Logger LOGGER = LogManager.getLogger(StartExecution.class);
  /**
   * 自动节点执行方法
   *
   * @param context 节点上下文
  ...
  public AutoNodeEvent execute(NodeContext context) {
    LoggerUtil.info(LOGGER, "StartExecution 1");
