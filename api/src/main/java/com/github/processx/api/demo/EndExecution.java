 ...
 *
 * @author zhanggangbo
 * @version v 0.1 2019/8/4 14:13
 */
public class EndExecution  implements AutoExecution {

  /** 日志记录 */
  private static final Logger LOGGER = LogManager.getLogger(EndExecution.class);
  /**
   * 自动节点执行方法
   *
   * @param context 节点上下文
  ...
  public AutoNodeEvent execute(NodeContext context) {
    LoggerUtil.info(LOGGER, "EndExecution 9");
