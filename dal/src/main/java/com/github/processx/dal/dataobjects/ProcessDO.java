...
public class ProcessDO {
  ...
  /**
   * This field was generated by MyBatis Generator. This field corresponds to the database column
   * process.record_process_instance
   *
   * @mbggenerated
   */
  ...
  public ProcessDO(
      ...
      String name,
      Integer version,
      Boolean recordProcessInstance,
      Boolean recordNodeInstance,
      Boolean recordGlobalParam,
      Boolean recordProcessInput,
      Boolean recordTriggerInput,
      Boolean recordTriggerResult,
      Date createTime,
      Date modifiedTime) {
    this.id = id;
    this.name = name;
  ...
  /**
   * This method was generated by MyBatis Generator. This method returns the value of the database
   * column process.record_process_instance
   *
  ...
  /**
   * This method was generated by MyBatis Generator. This method returns the value of the database
   * column process.record_node_instance
   *
  ...
  /**
   * This method was generated by MyBatis Generator. This method returns the value of the database
   * column process.record_global_param
   *
  ...
  /**
   * This method was generated by MyBatis Generator. This method returns the value of the database
   * column process.record_process_input
   *
  ...
  /**
   * This method was generated by MyBatis Generator. This method returns the value of the database
   * column process.record_trigger_input
   *
  ...
  /**
   * This method was generated by MyBatis Generator. This method returns the value of the database
   * column process.record_trigger_result
   *
